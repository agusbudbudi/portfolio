      ...
      <section className="flex flex-col gap-8 mb-14">
        <div className="flex flex-col sm:flex-row sm:items-start gap-8">
          <div className="relative w-[120px] h-[120px] min-w-[120px]">
            <img src="/img/profile/profile-agus.webp" alt="Agus Budiman" width={120} height={120} loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover rounded-2xl border-[4px] border-ld-canvas shadow-ld-subtle-3" />
