      ...
      <div className="flex items-center gap-3">
        {value ? (
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-ld-frost bg-white text-xs font-medium text-ld-violet hover:border-ld-violet"
          >
            <FileText size={13} /> Lihat CV
          </a>
        ) : (
          <span className="inline-flex items-center gap-1.5 text-xs text-ld-fog">
            <FileText size={13} /> Belum ada CV
          </span>
        )}
