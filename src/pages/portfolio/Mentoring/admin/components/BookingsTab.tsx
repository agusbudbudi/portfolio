  ...
  return (
    <div className={ADMIN_CARD}>
      <div className={`${ADMIN_CARD_HEADER} justify-between`}>
        <div>
          <h2 className="text-sm font-semibold uppercase tracking-widest text-ld-onyx m-0">Bookings</h2>
      ...
      <div className={ADMIN_CARD_BODY}>
        ...
        <div className="overflow-x-auto border border-ld-frost rounded-xl">
          ...
          <tbody>
            ...
            {sorted.length === 0 && (
              <tr>
                <td colSpan={6} className="px-4 py-8 text-center text-sm text-ld-fog">Belum ada booking.</td>
              </tr>
            )}
          </tbody>
          </table>
