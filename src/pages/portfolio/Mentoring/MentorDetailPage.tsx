...
import { ArrowLeft, Building2, Award, Calendar, Clock, MessageCircle } from 'lucide-react';
...
import type { MentorEmploymentType } from '../../../types/mentoring';
...
const mentorPlatforms = [
  ...
  { key: 'dealls' as const, name: 'Dealls', logo: '/img/mentoring/logo-dealls.webp' },
];
            ...
            <section>
              ...
              <div className="flex flex-col gap-3">
                {workExperience.map((entry) => (
                  ...
                  >
                    <div className="w-10 h-10 min-w-10 flex items-center justify-center bg-ld-canvas rounded-lg overflow-hidden">
                      {entry.companyLogo ? (
                        <img src={entry.companyLogo} alt={entry.company} loading="lazy" decoding="async" className="w-full h-full object-contain" />
                      ) : (
                        <Building2 size={16} className="text-ld-mist" />
                      )}
                    </div>
