              ...
              >
                ...
                <div className="bg-gradient-to-br from-ld-violet to-[#7cc3ff] p-8 pb-0 flex flex-col justify-center flex-shrink-0">
                  ...
                  <div className="flex justify-between items-start">
                    <img src="/personal-portfolio/img/diricare-logo.webp" alt="Diricare" width={45} height={45} loading="eager" decoding="async" className="h-[45px] max-w-[120px] object-contain rounded-[10px]" />
                    <img src="/personal-portfolio/img/qr-code.webp" alt="QR Code" width={45} height={45} loading="eager" decoding="async" className="w-[45px] h-[45px] bg-white rounded-[10px] object-contain" />
                  </div>
                  ...
                  <div className="w-[230px] h-[230px] rounded-xl overflow-hidden self-center">
                    <img src="/personal-portfolio/img/profile/hero-agus.webp" alt="Agus Budiman" width={230} height={230} loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover" />
                  </div>
                </div>
