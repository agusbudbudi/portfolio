...
const STATUS_TONE: Record<MentorVerificationStatus, StatusBadgeTone> = {
  pending: 'amber',
  verified: 'emerald',
  rejected: 'red',
};
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-ld-cloud text-left">
                    ...
                    <th className="px-4 py-3 text-xs font-medium text-ld-steel whitespace-nowrap">User ID</th>
                  ...
                  {pagedMentors.map((mentor) => (
                    <tr key={mentor.id} className="border-t border-ld-frost bg-white hover:bg-ld-cloud/50 transition-colors">
                      <td className="px-4 py-3 align-top">
                        <div className="flex items-start gap-3 min-w-[220px]">
                          <img
                            ...
                            alt=""
                            className="w-10 h-10 rounded-lg object-cover border border-ld-frost shrink-0"
                          />
                      ...
                      <td className="px-4 py-3 align-top whitespace-nowrap">
                        {mentor.userId ? (
                          <code className="text-[11px] text-ld-slate">{mentor.userId}</code>
                        ) : (
                      ...
                      <td className="px-4 py-3 align-top whitespace-nowrap">
                        <StatusBadge tone={STATUS_TONE[mentor.verificationStatus ?? 'verified']}>
